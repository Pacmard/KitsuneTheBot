...
module.exports = {
  name: 'changelogs',
  description: 'if you want me to log in another channel',
  async execute(msg: Message) {
    ...
    if (perms.has('ADMINISTRATOR')) {
      ...
      if (isEnabled) {
        if (isEnabled.logschannel !== msg.channel.id) {
          const removingCmdsVars = msg.content.replace('k!changelogs', '');
    ...
    return msg.reply('You don\'t have admin permissions to change message logs channel!');
  },
};
